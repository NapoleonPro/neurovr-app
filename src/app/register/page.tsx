// src/app/register/page.tsx (dengan perbaikan icon visibility)
'use client';
...
import { HiOutlineUser, HiOutlineMail, HiOutlineLockClosed, HiChevronDown } from 'react-icons/hi';
...
export default function RegisterPage() {
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto transform transition-all duration-700 ease-out hover:scale-[1.02]">
          <div className="bg-[#1C243A]/95 backdrop-blur-xl rounded-lg shadow-2xl overflow-hidden grid grid-cols-2 border border-white/10 hover:border-white/20 transition-all duration-500">
            ...
            <div className="relative h-[600px] overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-black/30 via-transparent to-black/60 transition-all duration-500 group-hover:from-black/20 group-hover:to-black/50"></div>
              
              {/* Logo dengan hover effect */}
              <div className="absolute top-4 left-4 z-10 transform transition-all duration-500 hover:scale-110 hover:drop-shadow-2xl">
                <Image
                  src="/neuronobg.png"
                  alt="NeuroVR Logo"
                  width={150}
              ...
              <div className="absolute top-20 right-10 w-2 h-2 bg-blue-400 rounded-full opacity-60 animate-pulse"></div>
              <div className="absolute top-32 right-20 w-1 h-1 bg-white rounded-full opacity-40 animate-ping"></div>
              <div className="absolute bottom-32 right-16 w-1.5 h-1.5 bg-purple-400 rounded-full opacity-50 animate-bounce"></div>
            </div>

            {/* Kolom Kanan: Form */}
            <div className="p-8 flex flex-col justify-center min-h-[600px] relative overflow-hidden">
              {/* Decorative gradients */}
              <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-blue-500/15 via-purple-500/10 to-transparent rounded-bl-full"></div>
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-purple-500/15 to-transparent rounded-tr-full"></div>
              ...
              <div className="max-w-md mx-auto w-full space-y-8 relative z-10">
                ...
                <div className="text-center transform transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-400 text-lg transition-all duration-300 hover:text-gray-300">
                    Sudah punya akun?{' '}
                    <Link href="/login" className="text-blue-400 hover:text-blue-300 transition-all duration-300 relative group font-medium">
                      Log in
                ...
                {/* Form dengan enhanced animations - FIXED ICON Z-INDEX */}
                <form onSubmit={handleRegister} className="space-y-6">
                  <div className="relative group">
                    <HiOutlineUser className="absolute top-1/2 left-4 -translate-y-1/2 text-gray-400 w-5 h-5 z-20 transition-all duration-300 group-hover:text-blue-400 group-focus-within:text-blue-500 group-hover:scale-110 pointer-events-none" />
                    <input
                      type="text"
                  ...
                  >
                    <span className="relative z-10 transition-all duration-300 group-hover:scale-105">Daftar</span>
                ...
                <div className="space-y-3">
                  ...
                  {message && (
                    <div className="bg-green-900/60 backdrop-blur-sm border border-green-600/50 rounded-xl p-4 shadow-lg
                                  transform transition-all duration-500 hover:scale-105 animate-pulse hover:shadow-green-500/20">
                      <p className="text-center text-green-300 text-sm font-medium">{message}</p>
                    </div>
                  )}
                </div>
              </div>
  ...
  // Mobile/Tablet Layout - Enhanced dengan zoom background juga
  return (
        ...
        <div className="w-full max-w-sm mx-auto bg-[#1C243A]/95 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/10 transform transition-all duration-500 hover:scale-105 hover:shadow-blue-500/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Sudah punya akun?{' '}
              <Link href="/login" className="text-blue-400 hover:text-blue-300 transition-all duration-300 hover:underline font-medium">
                Log in
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="relative group">
              <HiOutlineUser className="absolute top-1/2 left-3 -translate-y-1/2 text-gray-400 w-5 h-5 z-20 transition-all duration-300 group-hover:text-blue-400 group-focus-within:text-blue-500 pointer-events-none" />
              <input
                type="text"
                placeholder="Nama Lengkap"
                required
          ...
          <div className="mt-6 space-y-2">
            ...
            {message && (
              <div className="bg-green-900/60 backdrop-blur-sm border border-green-600/50 rounded-xl p-3 transform transition-all duration-300 hover:scale-105">
                <p className="text-center text-green-300 text-xs">{message}</p>
              </div>
            )}
          </div>
        </div>
